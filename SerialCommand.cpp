...
/**
 * This prints out a list of the currently recognised commands
 * 
 */
void SerialCommand::getHelp(){
...
/**
 * Converts the Command received to upper case.
 * 
 */

void SerialCommand::convertToUpper (char *str)
{
    int i=0;
    char c;
    while (str[i])
